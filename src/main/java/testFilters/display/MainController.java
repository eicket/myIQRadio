...
public class MainController
{
   ...
   static final org.apache.logging.log4j.Logger logger = LogManager.getLogger(PropertiesWrapper.class.getName());
    ...
    {
        logger.debug("scroll : " + event.getDeltaY() + ", upper : " + filterXAxis.getUpperBound());
        double delta = 1000;
    ...
    {
        logger.debug("filter taps changed with : " + event.getDeltaY());
    ...
    {
        logger.debug("alpha changed with : " + event.getDeltaY());
    ...
    void initialize()
    {
        ...
        timeline.getKeyFrames().add(new KeyFrame(Duration.millis(500), new EventHandler<ActionEvent>()
        {
            ...
            public void handle(ActionEvent actionEvent)
            {
                ...
                {
                    logger.debug("Fir filter coeef : " + coefficients[i]);
    ...
    double[] getPolyPhaseCoefficients(int iCutoff, int taps)
    {
        ...
        logger.debug("PolyPhase filter coeefs size : " + polyPhaseFilter.coefficients.length);
    ...
    double[] getFirCoefficients(int iCutoff, int taps)
    {
        ...
        logger.debug("Fir filter coeefs size : " + Coefficients.length);
        return Coefficients;
    }    
